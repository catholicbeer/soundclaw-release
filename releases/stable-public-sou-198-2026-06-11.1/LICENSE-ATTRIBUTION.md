...
- release_id: `stable-public-sou-198-2026-06-11.1`
- generated_at: `2026-06-11T19:51:23Z`
- runtime_ref: `8d367d44ca9c6a10b20f3b1ad740bcf23cd43984`
- pi_kit_ref: `a58e39a62b8da7ade273e610380cfda24f142702`
- skills_ref: `8622327dfda1146d14097fe368d2e0815c8f1618`
- runtime_config_ref: `runtime.toml.example@8d367d4`
- library_release_ref: `library-93d255d`
- default_skills: `browse-assets manage-output play-asset runtime-health set-volume show-asset show-outputs soundclaw-onboarding soundclaw-version stop-playback validate-config`

## SoundClaw-Owned Contents

- `runtime/`: staged runtime artifact from `soundclaw-runtime` ref
  `8d367d44ca9c6a10b20f3b1ad740bcf23cd43984`; workspace license declaration:
  `MIT OR Apache-2.0`
- `repos/soundclaw-pi-kit/`: curated install payload from
  `soundclaw-pi-kit` ref `a58e39a62b8da7ade273e610380cfda24f142702`; repo-level metadata at source ref: none;
...
- `repos/soundclaw-skills/`: selected skill payloads from
  `soundclaw-skills` ref `8622327dfda1146d14097fe368d2e0815c8f1618`; selected skills are named in
...
- `config/runtime.toml`: runtime config selected as
  `runtime.toml.example@8d367d4`; public-bundle license basis: Apache-2.0 under
