...
- release_id: `dev-sou-285-2026-07-02.1`
- generated_at: `2026-07-02T23:18:01Z`
- runtime_ref: `d5ac94369ebf358a4e7af7ceeb35ee07f7651aab`
- pi_kit_ref: `140029b8ddb7a8057d2a34ab438934ed8b284c3a`
- skills_ref: `d329c25d31796128608fd1d57af7c63d16d2a480`
- runtime_config_ref: `shared-phase3-motu-hw22-volume18`
...
- `runtime/`: staged runtime artifact from `soundclaw-runtime` ref
  `d5ac94369ebf358a4e7af7ceeb35ee07f7651aab`; workspace license declaration:
  `MIT OR Apache-2.0`
- `repos/soundclaw-pi-kit/`: curated install payload from
  `soundclaw-pi-kit` ref `140029b8ddb7a8057d2a34ab438934ed8b284c3a`; repo-level metadata at source ref: none;
...
- `config/runtime.toml`: runtime config selected as
  `shared-phase3-motu-hw22-volume18`; public-bundle license basis: Apache-2.0 under
