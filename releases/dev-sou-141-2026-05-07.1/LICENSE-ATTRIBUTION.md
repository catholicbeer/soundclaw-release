...
- release_id: `dev-sou-141-2026-05-07.1`
- generated_at: `2026-05-07T19:40:19Z`
- runtime_ref: `4da4216bdeb3cbe965f581cd204ce9393fa76e59`
- pi_kit_ref: `49c301c76df2646a66c9d665533441a8cbefa96d`
- skills_ref: `d5ec05e66a44b07ee8501b962f04e9c8ca2876be`
- runtime_config_ref: `runtime.toml.example@4da4216`
- library_release_ref: `library-91c9cdd`
- default_skills: `soundclaw-version soundclaw-onboarding runtime-health play-asset show-outputs`

## SoundClaw-Owned Contents

- `runtime/`: staged runtime artifact from `soundclaw-runtime` ref
  `4da4216bdeb3cbe965f581cd204ce9393fa76e59`; workspace license declaration:
  `MIT OR Apache-2.0`
- `repos/soundclaw-pi-kit/`: curated install payload from
  `soundclaw-pi-kit` ref `49c301c76df2646a66c9d665533441a8cbefa96d`; repo-level metadata at source ref: none;
...
- `repos/soundclaw-skills/`: selected skill payloads from
  `soundclaw-skills` ref `d5ec05e66a44b07ee8501b962f04e9c8ca2876be`; selected skills are named in
...
- `config/runtime.toml`: runtime config selected as
  `runtime.toml.example@4da4216`; public-bundle license basis: Apache-2.0 under
